/* ============================================================
   BR Técnico — app.js (Fase 1)
   Objetivo desta fase: carregar o elencos_2026.json e deixar o
   técnico navegar: Início → Escolher time → Ver elenco.
   ============================================================ */
...
// Guarda em que divisão (Série A/B) o técnico está olhando agora.
let divisaoAtual = "serie_a";

/* ---------- Salvamento local (herdado da Fase 0) ---------- */
...
function ligarBotoes() {
  ...
  if (btnNovo) {
    btnNovo.addEventListener("click", abrirTelaTimes);
  }
  ...
  if (btnVoltarTimes) {
    btnVoltarTimes.addEventListener("click", function () {
      mostrarTela("tela-times");
    });
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("BR Técnico — Fase 1 carregada.");
